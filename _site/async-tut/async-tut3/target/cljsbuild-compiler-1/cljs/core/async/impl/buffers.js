...
var v_28771 = this$.pop();
if(cljs.core.truth_((function (){var G__28770 = v_28771;
return (keep_QMARK_.cljs$core$IFn$_invoke$arity$1 ? keep_QMARK_.cljs$core$IFn$_invoke$arity$1(G__28770) : keep_QMARK_.call(null,G__28770));
})())){
this$.unshift(v_28771);
} else {
}
...
return cljs.core._write(writer__4226__auto__,"cljs.core.async.impl.buffers/RingBuffer");
});
...
return cljs.core._write(writer__4226__auto__,"cljs.core.async.impl.buffers/FixedBuffer");
});
...
return cljs.core._write(writer__4226__auto__,"cljs.core.async.impl.buffers/DroppingBuffer");
});
...
return cljs.core._write(writer__4226__auto__,"cljs.core.async.impl.buffers/SlidingBuffer");
});
